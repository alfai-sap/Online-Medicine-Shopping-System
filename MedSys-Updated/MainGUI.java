...
public class MainGUI {
    ...
    private void initializeLoginPanel() {
        ...
        // Create the header panel with the logo and brand name.
        JPanel headerPanel = new JPanel();
        headerPanel.setLayout(new FlowLayout(FlowLayout.CENTER)); // Center the logo and text.

        JLabel logoLabel = new JLabel(); // Placeholder for the logo image.
        try {
            // Replace with the actual path to your logo image file.
            ImageIcon logoIcon = new ImageIcon("C:\\Users\\sonny\\bluej\\MedSys\\MedSys\\images\\logo_nobg.png");
        ...
        JLabel brandLabel = new JLabel("LUMINA WELLNESS"); // Brand name.
        ...
        // Create the login form below the header.
        JPanel loginFormPanel = new JPanel();
        loginFormPanel.setLayout(new GridLayout(4, 2, 10, 10)); // Grid layout for the form.
        ...
        switchToSignupButton.addActionListener(e -> switchToPanel("Signup")); // Switch to the signup panel.
        ...
        // Add the header panel and login form to the main login panel.
        loginPanel.add(headerPanel, BorderLayout.NORTH); // Add the header at the top.
        loginPanel.add(loginFormPanel, BorderLayout.CENTER); // Add the login form below the header.
    }

    // Create and configure the signup panel.
    private void initializeSignupPanel() {
        signupPanel = new JPanel();
        signupPanel.setLayout(new GridLayout(5, 2, 10, 10)); // Grid layout with 5 rows and 2 columns.
        ...
        signupButton.addActionListener(e -> handleSignup()); // Attach the signup handler.

        switchToLoginButton = new JButton("Login");
        switchToLoginButton.addActionListener(e -> switchToPanel("Login")); // Switch to the login panel.
